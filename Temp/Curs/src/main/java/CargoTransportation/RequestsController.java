...
public class RequestsController  implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        req4.setOnAction(event -> {
            show_display("/CargoTransportation/Req4.fxml");
        });

        req3.setOnAction(event -> {
            show_display("/CargoTransportation/Req3.fxml");
        });

        req2.setOnAction(event -> {
            show_display("/CargoTransportation/Req2.fxml");
        });

        req1.setOnAction(event -> {
            show_display("/CargoTransportation/Req1.fxml");
        });
